...
Companion to: Thornton (2026a), "A Phenomenological Model for Evolving Dark Energy Inspired by DESI DR2" (https://github.com/eddycosmology/eddy-de-collapse)
...
Key findings:
We uncover a previously unidentified critical noise threshold-hereafter the **Thornton Noise Threshold (σ_c ≈ 0.05 +/- 0.01 in tuned parameters)** that constrains vacuum fluctuation amplitudes cosmologically. 
