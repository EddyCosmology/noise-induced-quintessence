...
Limitations: Euler-Maruyama method was used showing sufficient and convergent results (50,000 realizations, compared to a 500,000 realization run showed no significant change); higher order Milstein scheme tested but unstable due to implicit solve interaction. Future work: adaptive stepping, full perturbation analysis.
